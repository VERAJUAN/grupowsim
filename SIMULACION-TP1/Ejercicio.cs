                ...
                if (i == 0)
                {
                    ...
                    if (desde == 0 && hasta == 0)
                    {
                        tablaVectorEstado.Rows.Add(vectorEstado.nroEvento.ToString(), Math.Round(vectorEstado.reloj, 3).ToString(), (Evento)vectorEstado.evento, vectorEstado.pedido == 0 ? "-" : vectorEstado.pedido.ToString(),
                            vectorEstado.proxPedido.ToString(), ((Evento)vectorEstado.evento == Evento.LlegaPedido || (Evento)vectorEstado.evento == Evento.Inicio) ? Math.Round(numAleatorioLlegadaPedido, 3).ToString() : "-", Math.Round(vectorEstado.tiempoEntrePedidos, 3).ToString(), ((Evento)vectorEstado.evento == Evento.LlegaPedido || (Evento)vectorEstado.evento == Evento.Inicio) ? Math.Round(vectorEstado.proxLlegada, 3).ToString() : "-",
                            (Estado)vectorEstado.a1Estado, vectorEstado.a1Pedido == 0 ? "-" : vectorEstado.a1Pedido.ToString(), (i != 0 && vectorEstado.a1Pedido != vectorEstadoMasUno.a1Pedido) ? Math.Round(numAleatorio1, 3).ToString() : "-", (i != 0 && vectorEstado.a1Pedido != vectorEstadoMasUno.a1Pedido) ? Math.Round(vectorEstado.a1Tiempo, 3).ToString() : "-", (vectorEstado.a1ProxFin == 0 || vectorEstado.a1ProxFin == double.PositiveInfinity) ? "-" : Math.Round(vectorEstado.a1ProxFin, 3).ToString(), vectorEstado.a1Cola.ToString(),
                            (Estado)vectorEstado.a2Estado, vectorEstado.a2Pedido == 0 ? "-" : vectorEstado.a2Pedido.ToString(), (i != 0 && vectorEstado.a2Pedido != vectorEstadoMasUno.a2Pedido) ? Math.Round(numAleatorio2, 3).ToString() : "-", (i != 0 && vectorEstado.a2Pedido != vectorEstadoMasUno.a2Pedido) ? Math.Round(vectorEstado.a2Tiempo, 3).ToString() : "-", (vectorEstado.a2ProxFin == 0 || vectorEstado.a2ProxFin == double.PositiveInfinity) ? "-" : Math.Round(vectorEstado.a2ProxFin, 3).ToString(), vectorEstado.a2Cola.ToString(),
                            (Estado)vectorEstado.a3Estado, vectorEstado.a3Pedido == 0 ? "-" : vectorEstado.a3Pedido.ToString(), (i != 0 && vectorEstado.a3Pedido != vectorEstadoMasUno.a3Pedido) ? Math.Round(numAleatorio3, 3).ToString() : "-", (i != 0 && vectorEstado.a3Pedido != vectorEstadoMasUno.a3Pedido) ? Math.Round(vectorEstado.a3Tiempo, 3).ToString() : "-", (vectorEstado.a3ProxFin == 0 || vectorEstado.a3ProxFin == double.PositiveInfinity) ? "-" : Math.Round(vectorEstado.a3ProxFin, 3).ToString(), vectorEstado.a3Cola.ToString(),
                            (Estado)vectorEstado.a4Estado, vectorEstado.a4Pedido == 0 ? "-" : vectorEstado.a4Pedido.ToString(), (i != 0 && vectorEstado.a4Pedido != vectorEstadoMasUno.a4Pedido) ? Math.Round(numAleatorio4, 3).ToString() : "-", (i != 0 && vectorEstado.a4Pedido != vectorEstadoMasUno.a4Pedido) ? Math.Round(vectorEstado.a4Tiempo, 3).ToString() : "-", (vectorEstado.a4ProxFin == 0 || vectorEstado.a4ProxFin == double.PositiveInfinity) ? "-" : Math.Round(vectorEstado.a4ProxFin, 3).ToString(), vectorEstado.a4Cola.ToString(),
                            (Estado)vectorEstado.a5Estado, vectorEstado.a5Pedido == 0 ? "-" : vectorEstado.a5Pedido.ToString(), (i != 0 && vectorEstado.a5Pedido != vectorEstadoMasUno.a5Pedido) ? Math.Round(numAleatorio5, 3).ToString() : "-", (i != 0 && vectorEstado.a5Pedido != vectorEstadoMasUno.a5Pedido) ? Math.Round(vectorEstado.a5Tiempo, 3).ToString() : "-", (vectorEstado.a5ProxFin == 0 || vectorEstado.a5ProxFin == double.PositiveInfinity) ? "-" : Math.Round(vectorEstado.a5ProxFin, 3).ToString(), vectorEstado.a5ColaA4.ToString(),
                            vectorEstado.a5ColaA2.ToString(), vectorEstado.colaEncastreA3.ToString(), vectorEstado.colaEncastreA5.ToString(), vectorEstado.cantidadEnsamblesSolicitados.ToString(), vectorEstado.cantidadEnsamblesFinalizados.ToString(), Math.Round(vectorEstado.propEnsamRealSobreSolic, 3).ToString(), vectorEstado.maxCola1.ToString(), vectorEstado.maxCola2.ToString(), vectorEstado.maxCola3.ToString(), vectorEstado.maxCola4.ToString(),
